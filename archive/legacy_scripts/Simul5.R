...
p_range <- c(100,200,500,1000)


cat("Case 1:","\n")
for (k in p_range) {
  cat("n = 100,p =",k,"diag=1,offdiag=0.5","\n")
  name <- paste("Case1_p=", k, sep = "")
  assign(name, main_function_case1(n=100,p=k,diag=1,offdiag=0.5))  
}

cat("Case 2:","\n")
for (k in p_range) {
  cat("n = 100,p =",k,"diag=1,offdiag=0.5","\n")
  name <- paste("Case2_p=", k, sep = "")
  assign(name, main_function_case2(n=100,p=k,diag=1,offdiag=0.5))  
}
...
for (k in p_range) {
  cat("n = 100,p =",k,"diag=1,offdiag=0.75","\n")
  name <- paste("Case3_p=", k, "_Sp=0.75", sep = "")
  assign(name, main_function_case3(n=100,p=k,sparsity=0.75))  
}
